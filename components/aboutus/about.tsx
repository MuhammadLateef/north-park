...
import AboutImg from "@/public/images/destination/01.webp";
import Link from "next/link";

const AboutSection = () => {
  return (
    <div className="py-12">
      <div className="max-w-[85rem] mx-auto container px-4 sm:px-6">
        <h2 className="text-sky-400 md:text-6xl text-4xl heading mb-4 text-center">
          About us
        </h2>
